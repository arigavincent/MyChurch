...
import { fetchHomePayload } from '../services/api';
          ...
          <View style={styles.spotlightCard}>
            <View style={styles.spotlightHeader}>
              <View>
                ...
                <Text style={styles.spotlightIntro}>{isLiveReady ? 'Start with the latest teaching and stay ready for the stream.' : 'The main thing to open first today.'}</Text>
              </View>
